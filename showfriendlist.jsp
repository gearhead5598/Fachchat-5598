...
<%
    try {
        ...
        ps = cs.prepareStatement("select fr_accept.from_email,signup.FirstName,signup.SecondName,signup.pic,signup.status from signup ,fr_accept where signup.Email=fr_accept.from_email and fr_accept.self_email=?");
        ps.setString(1, em);
        rs = ps.executeQuery();
...
<div class="msg-R1"onclick="chatsection('<%=email%>')">
    ...
    <%
        ...
        {
   %>
         <div class="msg-C3" id="msgC3-id"  ></div>
   <%
        }
