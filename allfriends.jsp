    ...
    <body>
        ...
        <div class="friendR1">
            ...
            <%! 
                ...
                ResultSet rs1;
                String pic1 = "", from_email="", name1 = "", date1 = "", coverpic1 = "", email1 = "";
   ...
   <div class="friendC2" id="friendacceptC2show">
            <%
                try {
                   ...
                   String em = session.getAttribute("em")+"";
                    ps1 = cs1.prepareStatement("select fr_accept.from_email,signup.FirstName,signup.SecondName,signup.pic from signup ,fr_accept where signup.Email=fr_accept.from_email and fr_accept.self_email=?");
                    ps1.setString(1, em);
            ...
            %>
                ...
                <div class="shfrlistR1">         
                    ...
                    <div class="shfrlistC2">
                        ...
                        <div class="shfrlistc21">
                            <button class="shfrlistc21btn" onclick="" >Message</button>
                        </div>
